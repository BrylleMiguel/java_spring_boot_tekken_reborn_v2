...
// Fighter fighter = jdbcTemplate.queryForObject("SELECT * FROM fighter WHERE id
// = ?", new FighterRowMapper(), id);
// return Optional.ofNullable(fighter);
// }

// @Override
// public void save(Fighter fighter) {
// var insertFighter = "INSERT INTO fighters (name, damage_per_hit, health,
// resistance, anime_from, create_at) VALUES(?, ?, ?, ?, ?, ?)";
